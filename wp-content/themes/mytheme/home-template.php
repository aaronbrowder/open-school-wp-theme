...
<div class="home">
   ...
   <div class="container">
      ...
      <div class="home-announcements">
         <div class="home-announcement"><?php echo get_option('announcement1') ?></div>
         <div class="home-announcement"><?php echo get_option('announcement2') ?></div>
         <div class="home-announcement"><?php echo get_option('announcement3') ?></div>
         <div class="home-announcement"><?php echo get_option('announcement4') ?></div>
      </div>
   </div>
